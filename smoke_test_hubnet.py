...
runs = [
    [sys.executable, "main.py", "--dataset", "imdb", "--model", "HubNet_v1", "--epochs", "1", "--batch_size", "8", "--max_len", "128", "--seed", "42", "--d_model", "64", "--HubNet_slots", "8", "--HubNet_steps", "1"],
    ...
    [sys.executable, "main.py", "--dataset", "listops_synth", "--model", "HubNet_v1", "--epochs", "1", "--batch_size", "8", "--max_len", "128", "--seed", "42", "--d_model", "64", "--HubNet_slots", "8", "--HubNet_steps", "1"],
